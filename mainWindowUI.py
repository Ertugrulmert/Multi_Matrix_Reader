...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.streamView = QtMultimediaWidgets.QCameraViewfinder(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.streamView.sizePolicy().hasHeightForWidth())
        self.streamView.setSizePolicy(sizePolicy)
        self.streamView.setObjectName("streamView")
        self.horizontalLayout.addWidget(self.streamView)
